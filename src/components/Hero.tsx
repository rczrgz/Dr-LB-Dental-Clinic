...
export const Hero = () => {
  ...
  return (
    <>
      <section id="home" className="relative min-h-screen flex items-center pt-18 overflow-hidden">
        {/* Background Elements */}
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-teal-primary text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-teal-dark transition-all shadow-xl hover:shadow-teal-primary/20 transform hover:-translate-y-1"
                >
                  Book Appointment
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-white text-teal-primary border-2 border-teal-primary/20 px-8 py-4 rounded-full font-bold text-lg hover:bg-teal-soft transition-all transform hover:-translate-y-1"
                >
                  View Services
                </button>
              </div>
      ...
      {/* Book modal — outside <section> so z-index is clean */}
